package org.coder.lab0201springauthorizationserver.config;

import org.coder.lab0201springauthorizationserver.authorization.device.DeviceClientAuthenticationConverter;
import org.coder.lab0201springauthorizationserver.authorization.device.DeviceClientAuthenticationProvider;
import org.coder.lab0201springauthorizationserver.authorization.federation.FederatedIdentityIdTokenCustomizer;
import org.coder.lab0201springauthorizationserver.authorization.handler.LoginFailureHandler;
import org.coder.lab0201springauthorizationserver.authorization.handler.LoginSuccessHandler;
import org.coder.lab0201springauthorizationserver.authorization.handler.LoginTargetAuthenticationEntryPoint;
import org.coder.lab0201springauthorizationserver.authorization.sms.SmsCaptchaGrantAuthenticationConverter;
import org.coder.lab0201springauthorizationserver.authorization.sms.SmsCaptchaGrantAuthenticationProvider;
import org.coder.lab0201springauthorizationserver.constant.RedisConstants;
import org.coder.lab0201springauthorizationserver.constant.SecurityConstants;
import org.coder.lab0201springauthorizationserver.support.RedisOperator;
import org.coder.lab0201springauthorizationserver.support.RedisSecurityContextRepository;
import org.coder.lab0201springauthorizationserver.util.SecurityUtils;
